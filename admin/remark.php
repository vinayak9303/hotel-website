    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- Advanced Tables -->
                <form action="remarking.php" method="POST">
                        <div class="row">
                      
                <div class="col-md-4">

                        <label for="checkin_date" class="font-weight-bold text-black">Remark</label>
            ...
            <br>
            <br>
            <button class="btn btn-primary btn-block text-white " style="width:30%">Add</button>
