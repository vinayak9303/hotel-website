    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="findroom.php"><i class="fa fa-search"></i>Find Booking</a>
                    </li>
                   <li>
        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- Advanced Tables -->
                <form action="asigning.php" method="POST">
                        <div class="row">
                      
                <div class="col-md-4">

                        <label for="checkin_date" class="font-weight-bold text-black">Room No</label>
            ...
            <br>
            <br>
            <button class="btn btn-primary btn-block text-white " style="width:30%">Asign</button>
