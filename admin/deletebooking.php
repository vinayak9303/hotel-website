    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                        <label for="checkin_date" class="font-weight-bold text-black">Booking_Id</label>
                    <input type="text" class="form-control" name="booking">
                </div>
            </div>
            <br>
            <br>
            <center><button class="btn btn-primary btn-block text-white " style="width:30%">Cancel Booking</button></center>
